...
public class Producer {
	...
	public void sendMessage(final String messageText) {
		template.send(new MessageCreator() {
			...
			public Message createMessage(Session session) throws JMSException {
				...
				toFile.info("Sent message '" + messageText + "'");
	...
	public static void main(String[] args) throws Exception {
		...
		String jsonString = "{\"person\":{\"userId\":4229,\"userName\":\"smohan\",\"firstName\":\"sai\",\"lastName\":\"mohan\"},\"roles\":[\"Manager\",\"Developer\",\"Lead\",\"Product Manager\"]}";
